...
// Transcription (Whisper) désactivée par défaut en test — sans ça, une
// GROQ_API_KEY/OPENAI_API_KEY présente dans le .env local du développeur
// déclencherait un vrai appel réseau à chaque run de la suite REX (voir
// chantiers.test.ts pour les tests qui la réactivent explicitement, jeton et
// fetch mockés).
