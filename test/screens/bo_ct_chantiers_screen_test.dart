...
void main() {
  ...
  group('peutCreerDepuisListeVide (état vide — même règle pour les vues Chantiers et SAV)', () {
    test('création possible sur les segments En cours/Tous, hors recherche', () {
      expect(peutCreerDepuisListeVide(isSearching: false, segment: TableauChantiersSegment.enCours), isTrue);
      expect(peutCreerDepuisListeVide(isSearching: false, segment: TableauChantiersSegment.tous), isTrue);
    });

    test('pas de création en recherche, ni sur Terminés/À traiter', () {
      expect(peutCreerDepuisListeVide(isSearching: true, segment: TableauChantiersSegment.enCours), isFalse);
      expect(peutCreerDepuisListeVide(isSearching: false, segment: TableauChantiersSegment.termines), isFalse);
      expect(peutCreerDepuisListeVide(isSearching: false, segment: TableauChantiersSegment.aTraiter), isFalse);
    });
  });
}
